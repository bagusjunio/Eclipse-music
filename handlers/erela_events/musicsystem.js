...
function generateQueueEmbed(client, guildId, leave) {
  ...
  var embeds = [
    ...
    .setImage(`https://media.discordapp.net/attachments/923303798062080000/923582118712471612/bg.png?width=1214&height=683`)
    .setTitle(`Start Listening to Music, by connecting to a Voice Channel and sending either the **SONG LINK** or **SONG NAME** in this Channel!`)
    .setDescription(`> *I support <:yt:923246800117301258> Youtube, <:spotify:923246799999877200> Spotify, <:soundcloud:923246800104718376> Soundcloud and direct MP3 Links!*`)
  ]
